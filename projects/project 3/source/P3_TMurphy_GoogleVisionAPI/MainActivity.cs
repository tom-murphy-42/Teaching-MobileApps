...
namespace P3_TMurphy_GoogleVisionAPI
{
    [Activity(Label = "P3_TMurphy_GoogleVisionAPI", MainLauncher = true, Icon = "@mipmap/icon")]
    public class MainActivity : Activity
    {
        ...
        private void CreateDirectoryForPictures()
        {
            _dir = new Java.IO.File(
                Android.OS.Environment.GetExternalStoragePublicDirectory(
                    Android.OS.Environment.DirectoryPictures), "GoogleVisionApp");
            if (!_dir.Exists())
            {
                _dir.Mkdirs();
            }
        ...
        protected override void OnActivityResult(int requestCode, Result resultCode, Intent data)
        {
            ...
            }); // "subtle-isotope-190917", // "fabled-orbit-195800",
            ...
            if (apiResult != null)
            {
                Toast.MakeText(this.ApplicationContext, apiResult.ToString(), ToastLength.Short).Show();

                //Adapted from zeefree's repo (Zach Freeman)
                ...
                {
                    Toast.MakeText(this.ApplicationContext, item + "?", ToastLength.Short).Show();
                }
            }
